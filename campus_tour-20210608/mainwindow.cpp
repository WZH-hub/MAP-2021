    ...
    , ui(new Ui::MainWindow)
{
    ...
    //ani_1 = new QPropertyAnimation(ui->frame,"geometry");
    //ani_2 = new QPropertyAnimation(ui->frame_2,"geometry");
    //ani_3 = new QPropertyAnimation(ui->frame_3,"geometry");
...
/*void MainWindow::changeUser(){
    ...
    if(userComboBox->currentIndex() == 2){
        ani = ani_3;
        frame = ui->frame_3;
    }
...
void MainWindow::paintAni()//绘制一段动画
{
    if(idLocation<nextPath.size())
    {
        ...
        traffic = speedFlag;//修改表示此段模式为骑车、步行
