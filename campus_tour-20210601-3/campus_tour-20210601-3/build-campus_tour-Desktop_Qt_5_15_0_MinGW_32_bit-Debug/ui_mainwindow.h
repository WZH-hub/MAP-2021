...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setStyleSheet(QString::fromUtf8("image: url(:/map.png);"));
        frame = new QFrame(widget);
        frame->setObjectName(QString::fromUtf8("frame"));
        frame->setGeometry(QRect(0, 0, 41, 31));
        frame->setStyleSheet(QString::fromUtf8("image: url(:/mush.png);"));
        frame->setFrameShape(QFrame::StyledPanel);
        frame->setFrameShadow(QFrame::Raised);
        frame_2 = new QFrame(widget);
        frame_2->setObjectName(QString::fromUtf8("frame_2"));
        frame_2->setGeometry(QRect(40, 0, 41, 31));
        frame_2->setStyleSheet(QString::fromUtf8("image: url(:/master.jpg);"));
        frame_2->setFrameShape(QFrame::StyledPanel);
        frame_2->setFrameShadow(QFrame::Raised);
        frame_3 = new QFrame(widget);
        frame_3->setObjectName(QString::fromUtf8("frame_3"));
        frame_3->setGeometry(QRect(80, 0, 41, 41));
        frame_3->setStyleSheet(QString::fromUtf8("image: url(:/turtle.png);"));
        frame_3->setFrameShape(QFrame::StyledPanel);
        frame_3->setFrameShadow(QFrame::Raised);
        log = new QTextBrowser(widget);
        log->setObjectName(QString::fromUtf8("log"));
        log->setGeometry(QRect(0, 130, 251, 741));
