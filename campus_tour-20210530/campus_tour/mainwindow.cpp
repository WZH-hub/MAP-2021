...
void MainWindow::initScene(){   //初始化界面
        ...
        pixmap.load("../campus_tour/map.jpeg");
...
{
    QFile file;
    file.setFileName("F:/Qt5/2021-MAP/campus_tour-20210530/campus_tour/log.txt");
...
void MainWindow::setStartStation(){
    ...
    case 31:
        setStart(1267,542);break;
    case 32:
        setStart(1246,453);break;
    case 33:
        setStart(1227,542);break;
    case 34:
...
void MainWindow::setMidStation(){
    ...
    case 31:
        setMid(1267,542);break;
    case 32:
        setMid(1246,453);break;
    case 33:
        setMid(1227,542);break;
    case 34:
...
void MainWindow::setEndStation(){
    ...
    case 31:
        setEnd(1267,542);break;
    case 32:
        setEnd(1246,453);break;
    case 33:
        setEnd(1227,542);break;
    case 34:
...
void MainWindow::paintPath(){
    ...
    for(int i = 1; i < nextPath.size(); i++){   //把坐标存入路径中
        ...
        QString strtmp;
                QString temp = QString::number(nextPath[i]+1);
