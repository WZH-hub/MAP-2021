...
//    bool some=connect(ani,SIGNAL(finished()),this,SLOT(realPrint()));
    bool any=connect(this,SIGNAL(aniSignal()),this,SLOT(realPrintAni()));
//    qDebug()<<"bool"<<some<<"\n";
    qDebug()<<"bool"<<any<<"\n";
...
void MainWindow::realPrint()
{
    if(idLocation!=1)
    {
        ...
        qDebug()<<"idlocation"<<idLocation<<"\n";
            QString strtmp,temp;
    //        double unit_delay=1000.0;

            //Delay_MSec(20);
    //        Delay_MSec(delay);
            QString str_temp =startComboBox->itemText(nextPath[idLocation-1]+1);
...
void MainWindow::realPrintAni()
{
    if(idLocation<nextPath.size())
    {
        QString strtmp,temp;
        double unit_delay=30.0;
